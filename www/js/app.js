...
angular.module('jalsa', ['ionic', 'jalsa.controllers'])
...
.config(function ($stateProvider, $urlRouterProvider, $ionicConfigProvider, $httpProvider) {
	...
	.state('app.org-chart', {
		...
		views: {
			'menuContent': {
				templateUrl: 'templates/appView/org-chart.html',
				controller: "OrgCtrl"
			}
		}
	})
	.state('app.meetings', {
		...
		views: {
			'menuContent': {
				templateUrl: 'templates/appView/meetings.html',
	...
	.state('app.invitee', {
		...
		views: {
			'menuContent': {
				templateUrl: 'templates/appView/invitee.html',
				controller: "InviteeCtrl"
			}
		}
	})
	.state('app.redbook', {
		...
		views: {
			'menuContent': {
				templateUrl: 'templates/appView/redbook.html',
				controller: "RedbookCtrl"
			}
		}
	})
	.state('app.tasks', {
		...
		views: {
			'menuContent': {
				templateUrl: 'templates/appView/tasks.html',
				controller: "TasksCtrl"
			}
		}
	})
	.state('app.action-points', {
		url: '/action-points',
		views: {
			'menuContent': {
				templateUrl: 'templates/appView/action-points.html',
				controller: "ActionspointsCtrl"
			}
		}
	})
	.state('app.communications', {
		...
		views: {
			'menuContent': {
				templateUrl: 'templates/appView/communications.html',
